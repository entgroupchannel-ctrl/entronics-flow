      ...
      <div className="border-2 border-red-500 rounded p-4 mb-6">
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-2">
            <div className="text-red-500 font-bold">% 9 I 2 / C U S T O M E R :</div>
            <div className="text-sm space-y-1">
              <div>{quotationData.customer_name}</div>
              {quotationData.customer_address && (
                <div className="whitespace-pre-line">{quotationData.customer_address}</div>
              )}
              {quotationData.customer_phone && (
                <div>TEL: {quotationData.customer_phone}</div>
              )}
              {quotationData.customer_email && (
                <div>EMAIL: {quotationData.customer_email}</div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-2 text-right">
            <div className="text-red-500 font-bold">@% 5H@- QT2025099326</div>
            <div className="text-sm space-y-1">
              ...
              {quotationData.valid_until && (
                <div>วันหมดอายุ: {formatDate(quotationData.valid_until)}</div>
              )}
      ...
      <div className="grid grid-cols-2 gap-8 mt-8">
        <div className="text-center">
          ...
          <div className="border-t border-gray-400 pt-2">
            <div>ลงชื่อ ................................</div>
            <div className="text-sm mt-1">ผู้เสนอราคา</div>
          </div>
        </div>
        <div className="text-center">
          <div className="mb-16"></div>
          <div className="border-t border-gray-400 pt-2">
            <div>ลงชื่อ ................................</div>
            <div className="text-sm mt-1">ผู้รับใบเสนอราคา</div>
          </div>
        </div>
      </div>
