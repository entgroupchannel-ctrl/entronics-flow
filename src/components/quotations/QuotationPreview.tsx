...
const defaultCompanyInfo: CompanyInfo = {
  ...
  address: "เลขที่ 70/5 หมู่บ้านเมทโทร บิซทาวน์แจ้งวัฒนะ 2 หมู่ที่ 4\nตำบลคลองพระอุดม อำเภอปากเกร็ด จังหวัดนนทบุรี 11120",
  taxId: "0135558013167",
  phone: "02-045-6104",
    ...
    <div className={`${printMode ? '' : 'space-y-4'}`}>
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex items-start justify-between w-full">
          <div className="w-24 h-24 bg-white border border-gray-200 flex items-center justify-center ml-16 mt-16">
      ...
      <div className="border-2 border-gray-500 rounded p-4 mb-6">
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-2 text-right">
            <div className="text-gray-500 font-bold">REF: {quotationData.quotation_number || 'QT2025XXXXXX'}</div>
            <div className="text-sm space-y-1">
