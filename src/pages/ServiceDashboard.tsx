    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-card border rounded-lg p-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="customer-address">ที่อยู่สำหรับไปซ่อม</Label>
            <Textarea
              id="customer-address"
              value={formData.customer_address}
              onChange={(e) => setFormData(prev => ({...prev, customer_address: e.target.value}))}
              placeholder="ที่อยู่สำหรับไปซ่อม หรือนำมาส่ง"
              rows={3}
            />
          </div>
        </div>
        ...
        <div className="bg-card border rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Select value={formData.device_type} onValueChange={(value) => setFormData(prev => ({...prev, device_type: value}))}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="เครื่องสแกน">เครื่องสแกน</SelectItem>
                  <SelectItem value="เครื่องถ่ายเอกสาร">เครื่องถ่ายเอกสาร</SelectItem>
                  <SelectItem value="จอมอนิเตอร์">จอมอนิเตอร์</SelectItem>
            ...
            <div className="space-y-2">
              <Label htmlFor="device-brand">ยี่ห้อ</Label>
              <Input
                id="device-brand"
                value={formData.device_brand}
                onChange={(e) => setFormData(prev => ({...prev, device_brand: e.target.value}))}
                placeholder="ยี่ห้ออุปกรณ์"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="device-model">รุ่น</Label>
              <Input
                id="device-model"
        ...
        <div className="bg-card border rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="problem-description">อาการเสีย / ปัญหาที่พบ *</Label>
              <Textarea
        ...
        <div className="flex justify-end gap-2 pt-4">
          ...
          <Button onClick={onSubmit} disabled={isLoading}>
            {isLoading ? "กำลังบันทึก..." : "แจ้งซ่อม"}
          </Button>
        </div>
      </div>
    );
