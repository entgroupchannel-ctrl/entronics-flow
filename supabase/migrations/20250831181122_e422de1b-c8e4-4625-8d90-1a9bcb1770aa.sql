-- Create user_roles table (since app_role enum already exists)
...
-- Insert default admin role for existing users (optional - remove if not needed)
-- This gives admin role to the first user in the system
