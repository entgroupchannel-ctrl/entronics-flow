...
-- Create a function to check if user can manage customers
...
AS $$
  SELECT EXISTS (
    ...
    WHERE user_id = _user_id
      AND role IN ('admin'::app_role, 'accountant'::app_role, 'sales'::app_role, 'customer_service'::app_role)
  )
$$;
...
-- Add additional security: encrypt sensitive fields (conceptual - would need application-level implementation)
