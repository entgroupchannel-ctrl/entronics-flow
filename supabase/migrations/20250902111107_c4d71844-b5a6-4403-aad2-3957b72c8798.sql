...
-- Using existing roles: admin, accountant, sales, user
...
AS $$
  SELECT EXISTS (
    ...
    WHERE user_id = _user_id
      AND role IN ('admin'::app_role, 'accountant'::app_role, 'sales'::app_role)
  )
$$;
...
-- Add comments to document sensitive fields for security awareness
