...
DROP TRIGGER IF EXISTS trigger_auto_assign_technician_after ON public.service_requests;

-- สร้าง trigger ใหม่ที่ทำงาน AFTER INSERT
CREATE TRIGGER trigger_auto_assign_technician_after
  AFTER INSERT ON public.service_requests
  FOR EACH ROW
  EXECUTE FUNCTION auto_assign_technician_on_creation();

-- ปรับฟังก์ชัน auto_assign_technician_on_creation ให้ทำงานกับ AFTER trigger
